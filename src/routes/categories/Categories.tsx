                ...
                <Container>
                    ...
                    <div className="w-[312px] pr-[64px]" >
                        <ul className="flex flex-col gap-[16px] font-fixel text-[16px] text-[#212121] " >
                            ...
                            <li>
                                <Checkbox>Alfaparf</Checkbox>
                            </li>
                            <li>
                                <Checkbox>Kerastase</Checkbox>
                            </li>
                            <li>
                                <Checkbox>L'Oreak Paris</Checkbox>
                            </li>
                            <li>
                                <Checkbox>L'Oreak Professional</Checkbox>
                            </li>
                            <li>
                                <Checkbox>Matrix</Checkbox>
                            </li>
                            <li>
                                <Checkbox>Schwarzkopf Professional</Checkbox>
                            </li>
                            <li>
                                <Checkbox>-417</Checkbox>
                            </li>
                            <li>
                                <Checkbox>4 Seasons</Checkbox>
                            </li>
                            <li>
                                <Checkbox>4Organic</Checkbox>
                            </li>
                        </ul>
                    </div>
                    <CarouselCategory />
                    ...
                    <Container>
                        <div className="flex" >
                            <div className="w-[312px] pr-[20px] box-border" >
